...
create table if not exists public.user_entitlements (
  ...
  source text not null default 'manual'
    check (source in ('manual', 'stripe', 'promo', 'internal')),
...
on public.user_entitlements(source);
...
drop policy if exists "Users can read their own entitlements"
